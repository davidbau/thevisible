...
Yet now a decade later when [large language models are begnning to solve all these more-difficult tasks](https://papers.baulab.info/also/Bubek-2023.pdf), Marcus continues to [meet the results with skepticism](https://www.nytimes.com/2023/01/06/opinion/ezra-klein-podcast-gary-marcus.html), pointing at flaws in logic and flaws in knowledge as evidence that the models are not really thinking. But is perfect logic and perfect knowledge a hallmark of "thought?"  Certainly most of us human beings are not capable of total factual recall and flawless logical reasoning, yet we think.

This seeming need for an endless escalation of more-difficult external tasks for probing cognition suggests that Turing's basic assumption was missing something.  Turing proposed that we do not care what the implementation is inside a machine intelligence, that a convincing artifice would be just as good as th real thing.  But today, it is becoming increasingly clear that we *do* care what is inside the box.
...
We are in early days, and the mechanistic interpretability research program is very immature.  We do not yet have abstractions that describe what it is that we are doing in a satisfying way.  But as we grapple with the emergence of suprising intelligent behavior in large models, the detailed study of mechanisms within those models offers a new path for understanding what they are really learning.
